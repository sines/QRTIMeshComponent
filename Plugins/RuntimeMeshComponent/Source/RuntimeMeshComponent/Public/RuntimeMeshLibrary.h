...
class RUNTIMEMESHCOMPONENT_API URuntimeMeshLibrary : public UBlueprintFunctionLibrary
{
	...
	*/
	...
	/** Generate vertex and index buffer for a simple Cylinder, given the supplied dimensions. Normals, UVs and tangents are also generated for each vertex. */
	//////////////////////////////////////////////////////////////////////////
	UFUNCTION(BlueprintCallable, Category = "Components|RuntimeMesh")
	static void BuildCylinderMesh(const FVector& Base, const FVector& XAxis, const FVector& YAxis, const FVector& ZAxis, float Radius, float HalfHeight, int32 Sides, TArray<FVector>& Vertices, TArray<int32>& OutIndices);


	UFUNCTION(BlueprintCallable, Category = "Components|RuntimeMesh")
	static void BuildConeVerts(float Angle1, float Angle2, float Scale, float XOffset, int32 NumSides, TArray<FVector>& Vertices, TArray<int32>& OutIndices);
	//////////////////////////////////////////////////////////////////////////
	...
	*/
	...
	//////////////////////////////////////////////////////////////////////////
	void BuildAxis(const FVector& InLocation, bool bDrawWidget);
