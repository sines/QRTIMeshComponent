...
class FRuntimeQuVRHandleSceneProxy : public FStaticMeshSceneProxy
{
public:

	FRuntimeQuVRHandleSceneProxy(URuntimeQuVRHandleMeshComponent* InComponent)
...
URuntimeQuVRHandleMeshComponent::URuntimeQuVRHandleMeshComponent() :
	Super()
{
}

FPrimitiveSceneProxy* URuntimeQuVRHandleMeshComponent::CreateSceneProxy()
{
	...
	return new FRuntimeQuVRHandleSceneProxy(this);
}
